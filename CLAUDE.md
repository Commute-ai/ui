...
Commute.ai is a React Native mobile application built with Expo and TypeScript that provides intelligent commute planning. The app is currently at version v1.1.0 and uses Expo SDK 54.
